public class A727_MinimumWindowSubsequence {
    public static void main(String[] args) {
        A727_MinimumWindowSubsequence solution = new A727_MinimumWindowSubsequence();
        String s = "abcdebdde";
        String t = "bde";
     ...
     * 2. check optimization from right left
    ...
    public String minWindow(String S, String T) {
        ...
        while (right < S.length()) {
            ...
            // use another slow pointer to traverse from fast pointer to left until find first character of T in S
            int left = right;
            tIndex = T.length() - 1;
            while (left >= 0) {
