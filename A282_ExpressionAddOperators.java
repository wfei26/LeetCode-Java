...
public class A282_ExpressionAddOperators {
    public static void main(String[] args) {
        A282_ExpressionAddOperators solution = new A282_ExpressionAddOperators();
        String input = "232";
        List<String> output = solution.addOperators(input, 8);
     ...
     * add multiplication result between previous number and current number.
     * */
