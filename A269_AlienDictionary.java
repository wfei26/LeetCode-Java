...
public class A269_AlienDictionary {
    public static void main(String[] args) {
        A269_AlienDictionary solution = new A269_AlienDictionary();
    ...
    public String alienOrder(String[] words) {
        ...
        // MUST initialize the map, to avoid null exception for those character that
        // will have zero inDegrees (i.e. starting characters)
        ...
        while (!queue.isEmpty()) {
            ...
            // traverse all next node of current node in graph, update inDegree value
            // then put all nodes with zero inDegree into queue
