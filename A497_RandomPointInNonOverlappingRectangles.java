...
public class A497_RandomPointInNonOverlappingRectangles {
    public static void main(String[] args) {
        int[][] input = {{-2,-2,-1,-1}, {1,0,3,0}};
        A497_RandomPointInNonOverlappingRectangles solution = new A497_RandomPointInNonOverlappingRectangles(input);
        int[] output = solution.pick();
     ...
     * */
    public A497_RandomPointInNonOverlappingRectangles(int[][] rects) {
        treeMap = new TreeMap<>();
        rand = new Random();
        myRects = rects;
    ...
    public int[] pick() {
        // treeMap.ceilingKey(): Returns the least key greater than or equal to the given key, or null if there is no such key.
